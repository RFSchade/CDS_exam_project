...
Though the data has been cleaned (see *\'Data_cleaning_markdown.Rmd\'*), I will need help from the *\'tidiverse\'* package to manipulate it into a shape more beneficient to visialisation, as well as plotting the data. 
