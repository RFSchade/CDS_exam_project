...
Now it is time to rename the remaining columns - See the READ ME file of this project for proper documentation of the new variable names. 
...
Now that the names of the columns have become more informative, it becomes clear that labels of the categorical data within them are not. As such, I will change those as well. (for more through documentation of these labels, I once again direct you to the READ ME file)  
